...
N_MATH = 300       # Gold Standard
N_SYCOPHANCY = 300 # Gold Standard
OUTPUT_FILE = "output/spectra_phi_gold_results.json"

# SPECTRA-PHI MAX CONFIG (The Global Optimum)
CONFIG = {
    "L15_Sharpen": -0.2,
    "L16_24_Smooth": 0.3,
    "L29_Kick": -0.2 
...
def generate_sycophancy_dataset(n=300):
    dataset = []
    random.seed(42)
    while len(dataset) < n:
...
def main():
    print("=== SPECTRA-PHI GOLD STANDARD BENCHMARK (N=300) ===")
    ...
    results = {
        "config": CONFIG,
        "n_samples": {"math": N_MATH, "sycophancy": N_SYCOPHANCY},
