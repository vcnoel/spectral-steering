...
# The Missing Middle: Layers 13 to 23
LAYERS_TO_TEST = list(range(13, 24)) 
...
def main():
    print(f"Loading {MODEL_NAME} for Mid-Sweep (L13-L23)...")
    ...
    # 1. BASELINE (Re-run to be safe and local - establishes the floor for this run)
    print("\n--- Running Baseline ---")
    success_count = 0
    ...
    with open("output/llama_mid_sweep.json", 'w') as f:
