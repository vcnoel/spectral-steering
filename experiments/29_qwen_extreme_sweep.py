...
def main():
    print(f"Loading {MODEL_NAME} for Extreme Check (L{TARGET_LAYER})...")
    ...
    # Save baseline first
    with open("output/qwen_extreme_sweep.json", 'w') as f:
    ...
    for strength in STRENGTHS:
        ...
        def hook(module, input_args, output):
            ...
            if spec_norm > 1e-6:
                # Same formula: vec / norm * hidden_norm * 0.1 * strength
                # So strength 1.0 means perturbation is 10% of hidden state norm
