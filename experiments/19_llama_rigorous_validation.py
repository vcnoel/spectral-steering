...
# TARGET_LAYER updated after sensitivity scan found brittle "Void" at L2 (10%)
TARGET_LAYER = 2 
STEER_STRENGTH = 1.0 # Llama is usually more stable
...
def main():
    ...
    with open("output/llama_rigorous_results.json", 'w') as f:
